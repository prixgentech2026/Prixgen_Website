...
export default defineType({
  name: 'engineeringServicesPage',
  title: 'Engineering Services Page',
  type: 'document',
  fields: [
    defineField({
      name: 'title',
      title: 'Page Title',
      type: 'string',
      description: 'The main headline for the engineering services page (e.g., Industrial Engineering Services)',
