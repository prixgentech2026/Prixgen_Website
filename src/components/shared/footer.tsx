    ...
    <footer className="bg-prixgen-dark text-white py-16 mt-20">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li><Link href="/about-us" className="hover:text-prixgen-lightblue transition-colors">Strategic Audits</Link></li>
            <li><Link href="/implementation-rescue" className="hover:text-prixgen-lightblue transition-colors">Implementation Rescue</Link></li>
